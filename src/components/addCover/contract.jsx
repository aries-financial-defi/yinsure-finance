//i18n => {"addCover.contract.Text.1":"Days","addCover.contract.Text.2":"Max","addCover.contract.Text.3":"The number of days to be covered for.","addCover.contract.Text.4":"Amount","addCover.contract.Text.5":"Enter the amount you want to be covered for.","addCover.contract.Text.6":"Get quote","addCover.contract.Text.7":"Generate your quote","addCover.contract.Text.8":"Cover Cost","addCover.contract.Text.9":"Contract","addCover.contract.Text.10":"Cover Amount","addCover.contract.Text.11":"Cover Period","addCover.contract.Text.12":"{ quote.period } days","addCover.contract.Text.13":"Cover Expires","addCover.contract.Text.14":"Apply"}
  	...
  	return (<div className={ classes.actionsContainer }>
  		<div className={ classes.tradeContainer }>
  			<div className={ classes.title }>
  				<div>
  					<Typography variant='h4' className={ classes.value } noWrap id="addCover.contract.Text.1" >{i18next.t('addCover.contract.Text.1')}</Typography>
  				</div>
  				<div className={ classes.balances }>
  					<Typography variant='h4' onClick={ () => { this.setMax(); } } className={ classes.value } noWrap id="addCover.contract.Text.2" >{i18next.t('addCover.contract.Text.2')}</Typography>
  				</div>
  			</div>
  			<TextField
  				fullWidth
  				...
  				helperText={
  					<div className={ classes.info }>
  						...
  						<Typography variant='h5' id="addCover.contract.Text.3" >{i18next.t('addCover.contract.Text.3')}</Typography>
  					</div>
  				}
  			/>
  			...
  			<div className={ classes.title }>
  				<div>
  					<Typography variant='h4' className={ classes.value } noWrap id="addCover.contract.Text.4" >{i18next.t('addCover.contract.Text.4')}</Typography>
  				</div>
  				<div className={ classes.balances }>
  			...
  			<TextField
  				...
  				helperText={
  					<div className={ classes.info }>
  						<InfoIcon style={{ fontSize: 18, marginRight: '6px' }} />
  						<Typography variant='h5' id="addCover.contract.Text.5" >{i18next.t('addCover.contract.Text.5')}</Typography>
  					</div>
  				}
  			/>
  			<div className={ classes.buttons }>
  				<Button
  					...
  					fullWidth
  				>
  					<Typography className={ classes.buttonText } variant={ 'h5' } color={ 'secondary' } id="addCover.contract.Text.6" >{i18next.t('addCover.contract.Text.6')}</Typography>
  				</Button>
  			</div>
  		</div>
          ...
          <div className={ classes.generateQuoteContainer }>
          	<Typography variant='h3' id="addCover.contract.Text.7" >{i18next.t('addCover.contract.Text.7')}</Typography>
          </div>
  			}
  			{
  				quote &&
          <div className={ classes.quoteContainer }>
          	<div className={ classes.field }>
          		<Typography variant='h3' className={ classes.fieldTitle } id="addCover.contract.Text.8" >{i18next.t('addCover.contract.Text.8')}</Typography>
          		<Typography variant='h3' className={ classes.fieldValue }>{ (quote.price/1e18).toFixed(4) } { quote.currency }</Typography>
          	</div>
          	<div className={ classes.field }>
          		<Typography variant='h4' className={ classes.fieldTitle } id="addCover.contract.Text.9" >{i18next.t('addCover.contract.Text.9')}</Typography>
          		<Typography variant='h4' className={ classes.fieldValue }>{ quoteContract }</Typography>
          	</div>
          	<div className={ classes.field }>
          		<Typography variant='h4' className={ classes.fieldTitle } id="addCover.contract.Text.10" >{i18next.t('addCover.contract.Text.10')}</Typography>
          		<Typography variant='h4' className={ classes.fieldValue }>{ quote.amount } { quote.currency }</Typography>
          	</div>
          	<div className={ classes.field }>
          		<Typography variant='h4' className={ classes.fieldTitle } id="addCover.contract.Text.11" >{i18next.t('addCover.contract.Text.11')}</Typography>
          		<Typography variant='h4' className={ classes.fieldValue } id="addCover.contract.Text.12" >{ quote.period } {i18next.t('addCover.contract.Text.12')}</Typography>
          	</div>
          	<div className={ classes.field }>
          		<Typography variant='h4' className={ classes.fieldTitle } id="addCover.contract.Text.13" >{i18next.t('addCover.contract.Text.13')}</Typography>
          	...
          	<div className={ classes.buttons }>
          		<Button
          			...
          			fullWidth
          		>
          			<Typography className={ classes.applyButtonText } variant={ 'h5' } color={ 'secondary' } id="addCover.contract.Text.14" >{i18next.t('addCover.contract.Text.14')}</Typography>
          		</Button>
          	</div>
          </div>
  			}
