//i18n => {"addCover.addCover.Text.1":"Connect your wallet to continue","addCover.addCover.Text.2":"Cover Available"}
  			...
  			<div className={ classes.root }>
  				<div className={ classes.loggedOut }>
  					<div className={ classes.introCenter }>
  						<Typography variant='h3' id="addCover.addCover.Text.1" >{i18next.t('addCover.addCover.Text.1')}</Typography>
  					</div>
  				</div>
  			</div>
  		);
  				...
  				>
  					<div className={ classes.assetSummary }>
  						...
  						<div className={classes.heading}>
  							<Typography variant={ 'h5' } className={ classes.grey } id="addCover.addCover.Text.2" >{i18next.t('addCover.addCover.Text.2')}</Typography>
